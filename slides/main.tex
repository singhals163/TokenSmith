...
\texttt{sentence-transformers} (Nomic-v1.5, MiniLM). Add a BLEU metric;
fix a bug that was silently disabling the GPU for the test suite.
...
\textbf{$\sim$\,45 s} (optimized, on a 4-core / 8\,GiB laptop GPU)
\end{block}
